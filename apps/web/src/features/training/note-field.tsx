...
// One shared note editing/display pattern for both session-level and
// exercise-level notes — a single interaction model (preview → click →
// edit dialog → save → preview) rather than two.
